...
export function calc(source) {
  ...
  if (source.getAttribute("instruction") === "r") turnright();
  if (source.getAttribute("instruction") === "l") turnleft();
...
function updateHTML() {
  ...
  if (Data[0] === "2") {
    ...
    document.getElementById(clickedX + " " + clickedY).innerHTML =
      '<img src="/assets/' + Data[2] + '">';
  } else if (Data[0] === "3") {
    document.getElementById("newcard").innerHTML =
      '<img id="preview" class="card-preview" src="/assets/' + Data[1] + '">';
  }
